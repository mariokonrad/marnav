#ifndef MARNAV_SEATALK_MESSAGE_23_HPP
#define MARNAV_SEATALK_MESSAGE_23_HPP
...
private:
	bool sensor_defective_{false};
	uint8_t temperature_celsius_{0}; // degrees celsius
	uint8_t temperature_fahrenheit_{0}; // degrees fahrenheit
