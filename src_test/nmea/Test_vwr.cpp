...
class Test_vwr : public ::testing::Test
{
};

TEST_F(Test_vwr, contruction)
{
	nmea::vwr vwr;
}

TEST_F(Test_vwr, size)
{
	EXPECT_EQ(120u, sizeof(nmea::vwr));
}

TEST_F(Test_vwr, parse)
{
...
TEST_F(Test_vwr, empty_to_string)
{
	nmea::vwr vwr;
...
TEST_F(Test_vwr, set_angle_to_string)
{
	nmea::vwr vwr;
