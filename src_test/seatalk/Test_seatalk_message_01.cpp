...
{
	EXPECT_ANY_THROW(seatalk::message_01::parse({0x01, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}));
	EXPECT_ANY_THROW(seatalk::message_01::parse({0x01, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}));
}
...
TEST_F(Test_seatalk_message_01, parse)
{
	...
	std::vector<test_case> cases{
		...
		{{0x01, 0x05, 0x00, 0x00, 0x00, 0x60, 0x01, 0x00}, {0x00, 0x00, 0x00, 0x60, 0x01, 0x00}},
		// ST60 Tridata
		{{0x01, 0x05, 0x04, 0xBA, 0x20, 0x28, 0x01, 0x00}, {0x04, 0xBA, 0x20, 0x28, 0x01, 0x00}},
		// ST60 Log
		{{0x01, 0x05, 0x70, 0x99, 0x10, 0x28, 0x01, 0x00}, {0x70, 0x99, 0x10, 0x28, 0x01, 0x00}},
		// ST80 Masterview
		{{0x01, 0x05, 0xF3, 0x18, 0x00, 0x26, 0x0F, 0x06}, {0xF3, 0x18, 0x00, 0x26, 0x0F, 0x06}},
		// ST80 Maxi Display
		{{0x01, 0x05, 0xFA, 0x03, 0x00, 0x30, 0x07, 0x03}, {0xFA, 0x03, 0x00, 0x30, 0x07, 0x03}},
		// Smart Controller Remote Control Handset
		{{0x01, 0x05, 0xFF, 0xFF, 0xFF, 0xD0, 0x00, 0x00}, {0xFF, 0xFF, 0xFF, 0xD0, 0x00, 0x00}},
	};
