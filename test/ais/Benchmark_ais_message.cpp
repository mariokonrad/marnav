...
static std::vector<message_data> messages = {
	...
	{"message_05", {{"55P5TL01VIaAL@7WKO@mBplU@<PDhh000000001S;AJ::4A80?4i@E53", 0},
					   {"1@0000000000000", 2}}},
...
{
	state.SetLabel(messages[state.range_x()].label);
	while (state.KeepRunning()) {
		auto tmp = marnav::ais::make_message(messages[state.range_x()].data);
