...
TEST_F(Test_seatalk_message_50, construction)
{
	EXPECT_NO_THROW(message_50 m);
}
...
TEST_F(Test_seatalk_message_50, parse)
{
	...
	const std::vector<test_case> cases{
		{{0x50, 0x02, 0x00, 0x00, 0x00}}, {{0x50, 0x02, 0x0a, 0x00, 0x00}},
		{{0x50, 0x02, 0x00, 0x01, 0x00}}, {{0x50, 0x02, 0x00, 0x00, 0x01}},
	};
