...
TEST_F(Test_seatalk_message_52, construction) { EXPECT_NO_THROW(message_52 m); }
...
TEST_F(Test_seatalk_message_52, parse)
{
	...
	const std::vector<test_case> cases{
		{{0x52, 0x01, 0x00, 0x01}, 0.1},
		{{0x52, 0x01, 0x00, 0x10}, 1.6},
		{{0x52, 0x01, 0x01, 0x00}, 2.6},
		{{0x52, 0x01, 0x10, 0x00}, 0.0},
	};
