...
TEST_F(Test_nmea_r00, contruction) { EXPECT_NO_THROW(nmea::r00 r00); }

TEST_F(Test_nmea_r00, properties) { nmea_sentence_traits<nmea::r00>(); }
...
{
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::r00>(nmea::talker_id::none, {13, "@"}));
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::r00>(nmea::talker_id::none, {15, "@"}));
}
