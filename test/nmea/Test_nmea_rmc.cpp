...
TEST_F(Test_nmea_rmc, properties) { nmea_sentence_traits<nmea::rmc>(); }
...
{
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::rmc>(nmea::talker_id::none, {10, "@"}));
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::rmc>(nmea::talker_id::none, {13, "@"}));
}
