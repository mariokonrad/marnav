...
TEST_F(Test_nmea_rte, contruction) { EXPECT_NO_THROW(nmea::rte rte); }
...
{
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::rte>("@@", {2, "@"}));
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::rte>("@@", {14, "@"}));
}
