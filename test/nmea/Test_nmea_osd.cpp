...
TEST_F(Test_nmea_osd, properties) { nmea_sentence_traits<nmea::osd>(); }
...
{
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::osd>(nmea::talker_id::none, {8, "@"}));
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::osd>(nmea::talker_id::none, {10, "@"}));
}
