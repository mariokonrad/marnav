...
TEST_F(Test_nmea_pgrmm, contruction) { nmea::pgrmm pgrmm; }

TEST_F(Test_nmea_pgrmm, properties) { nmea_sentence_traits<nmea::pgrmm>(); }
...
{
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::pgrmm>(nmea::talker_id::none, {2, "@"}));
}
