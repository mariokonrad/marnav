...
TEST_F(Test_nmea_tds, properties) { nmea_sentence_traits<nmea::tds>(); }
...
{
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::tds>("@@", {1, "@"}));
	EXPECT_ANY_THROW(nmea::sentence_parse<nmea::tds>("@@", {3, "@"}));
}
