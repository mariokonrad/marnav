...
namespace
{
class test_math_floatingpoint : public ::testing::Test
{
};

TEST_F(test_math_floatingpoint, is_zero)
{
...
TEST_F(test_math_floatingpoint, is_zero_epsilon)
{
...
TEST_F(test_math_floatingpoint, is_zero_two_epsilon)
{
...
TEST_F(test_math_floatingpoint, is_same_zero_zero)
{
...
TEST_F(test_math_floatingpoint, is_same_zero_epsilon)
{
...
TEST_F(test_math_floatingpoint, is_same_zero_two_epsilon)
{
...
TEST_F(test_math_floatingpoint, is_same_zero_one)
{
...
TEST_F(test_math_floatingpoint, is_same_pos_neg)
{
