...
private:
	...
	optional<char> message_mode; // C:complete route, W:working route
	optional<std::string> waypoint_id[10]; // names or numbers of the active route
...
public:
	...
	optional<std::string> get_waypoint_id(int index) const;
