...
static const std::vector<entry> known_messages = {
	REGISTER_MESSAGE(message_00),
	REGISTER_MESSAGE(message_01),
	REGISTER_MESSAGE(message_05),
	REGISTER_MESSAGE(message_10),
	REGISTER_MESSAGE(message_11),
	REGISTER_MESSAGE(message_20),
	REGISTER_MESSAGE(message_21),
	REGISTER_MESSAGE(message_22),
	REGISTER_MESSAGE(message_23),
	REGISTER_MESSAGE(message_23),
	REGISTER_MESSAGE(message_25),
	REGISTER_MESSAGE(message_26),
	REGISTER_MESSAGE(message_27),
	REGISTER_MESSAGE(message_30),
	REGISTER_MESSAGE(message_36),
	REGISTER_MESSAGE(message_38),
	REGISTER_MESSAGE(message_50),
	REGISTER_MESSAGE(message_51),
	REGISTER_MESSAGE(message_52),
	REGISTER_MESSAGE(message_53),
	REGISTER_MESSAGE(message_54),
	REGISTER_MESSAGE(message_56),
	REGISTER_MESSAGE(message_58),
	REGISTER_MESSAGE(message_59),
	REGISTER_MESSAGE(message_65),
	REGISTER_MESSAGE(message_66),
	REGISTER_MESSAGE(message_6c),
	REGISTER_MESSAGE(message_86),
	REGISTER_MESSAGE(message_87),
	REGISTER_MESSAGE(message_89),
};
