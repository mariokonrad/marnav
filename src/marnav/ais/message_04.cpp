...
utils::optional<geo::longitude> message_04::get_lon() const
{
...
utils::optional<geo::latitude> message_04::get_lat() const
{
...
void message_04::set_lon(const utils::optional<geo::longitude> & t)
{
	longitude_minutes = t
...
void message_04::set_lat(const utils::optional<geo::latitude> & t)
{
	latitude_minutes = t
