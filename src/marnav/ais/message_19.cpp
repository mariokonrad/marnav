...
std::unique_ptr<message> message_19::parse(const raw & bits) throw(
...
void message_19::read_data(const raw & bits) throw(std::out_of_range)
{
...
raw message_19::get_data() const throw(std::out_of_range) 
{
	raw bits{SIZE_BITS};
