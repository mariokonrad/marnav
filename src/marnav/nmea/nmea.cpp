...
static const std::vector<entry> known_sentences = {
	...
	REGISTER_SENTENCE(dpt), REGISTER_SENTENCE(dsc), REGISTER_SENTENCE(fsi),
	REGISTER_SENTENCE(gga), REGISTER_SENTENCE(gll), REGISTER_SENTENCE(gns),
	REGISTER_SENTENCE(gsa), REGISTER_SENTENCE(gsv), REGISTER_SENTENCE(hdg),
	REGISTER_SENTENCE(hdm), REGISTER_SENTENCE(hsc), REGISTER_SENTENCE(mtw),
