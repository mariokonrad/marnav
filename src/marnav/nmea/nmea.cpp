...
static const std::vector<entry> known_sentences = {
	// regular
	REGISTER_SENTENCE(aam), REGISTER_SENTENCE(alm), REGISTER_SENTENCE(alr),
	REGISTER_SENTENCE(ack), REGISTER_SENTENCE(apa), REGISTER_SENTENCE(apb),
	REGISTER_SENTENCE(bec), REGISTER_SENTENCE(bod), REGISTER_SENTENCE(bwc),
	...
	REGISTER_SENTENCE(vwe), REGISTER_SENTENCE(vwr), REGISTER_SENTENCE(wcv),
	REGISTER_SENTENCE(wdc), REGISTER_SENTENCE(wdr), REGISTER_SENTENCE(wnc),
	...
	REGISTER_SENTENCE(zfi), REGISTER_SENTENCE(zfo), REGISTER_SENTENCE(zlz),
	REGISTER_SENTENCE(zpi), REGISTER_SENTENCE(zta), REGISTER_SENTENCE(zte),
