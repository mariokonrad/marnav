...
static const std::vector<entry> known_sentences = {REGISTER_SENTENCE(aam),
	REGISTER_SENTENCE(alm), REGISTER_SENTENCE(apb), REGISTER_SENTENCE(bod),
	...
	REGISTER_SENTENCE(rsa), REGISTER_SENTENCE(rte), REGISTER_SENTENCE(vdm),
	REGISTER_SENTENCE(vdo), REGISTER_SENTENCE(vhw), REGISTER_SENTENCE(vlw),
