...
static const std::vector<entry> known_sentences = {
	...
	REGISTER_SENTENCE(apa), REGISTER_SENTENCE(apb), REGISTER_SENTENCE(bec),
	...
	REGISTER_SENTENCE(hdt), REGISTER_SENTENCE(hsc), REGISTER_SENTENCE(its),
	REGISTER_SENTENCE(lcd), REGISTER_SENTENCE(mob), REGISTER_SENTENCE(msk),
	REGISTER_SENTENCE(mss), REGISTER_SENTENCE(mta), REGISTER_SENTENCE(mtw),
	...
	REGISTER_SENTENCE(sfi), REGISTER_SENTENCE(stn), REGISTER_SENTENCE(tds),
