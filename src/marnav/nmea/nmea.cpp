...
static const std::vector<entry> known_sentences
	= {REGISTER_SENTENCE(aam), REGISTER_SENTENCE(alm), REGISTER_SENTENCE(apb),
		REGISTER_SENTENCE(bod), REGISTER_SENTENCE(bwc), REGISTER_SENTENCE(dbk),
		REGISTER_SENTENCE(dbt), REGISTER_SENTENCE(dpt), REGISTER_SENTENCE(gga),
		REGISTER_SENTENCE(gll), REGISTER_SENTENCE(gsa), REGISTER_SENTENCE(gsv),
		REGISTER_SENTENCE(hdg), REGISTER_SENTENCE(hdm), REGISTER_SENTENCE(mtw),
		...
		REGISTER_SENTENCE(rmc), REGISTER_SENTENCE(rot), REGISTER_SENTENCE(rsa),
		REGISTER_SENTENCE(rte), REGISTER_SENTENCE(vdm), REGISTER_SENTENCE(vdo),
