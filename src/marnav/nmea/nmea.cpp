...
static const std::vector<entry> known_sentences = {
	...
	REGISTER_SENTENCE(dtm), REGISTER_SENTENCE(fsi), REGISTER_SENTENCE(gga),
	REGISTER_SENTENCE(gll), REGISTER_SENTENCE(gns), REGISTER_SENTENCE(gsa),
	REGISTER_SENTENCE(gsv), REGISTER_SENTENCE(hdg), REGISTER_SENTENCE(hdm),
	REGISTER_SENTENCE(hsc), REGISTER_SENTENCE(mtw), REGISTER_SENTENCE(mwd),
	...
	REGISTER_SENTENCE(sfi), REGISTER_SENTENCE(tll), REGISTER_SENTENCE(ttm),
