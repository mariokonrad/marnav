...
enum class manufacturer_id = {
	...
	BMT, ///< Bosch Rexroth Ag Marine Technique
	...
	CNX, ///< Cynex Manufactoring Company
	CPL, ///< Computrol, Inc.
	CPN, ///< Compunav
	...
	MTG, ///< Narine Technical Assistance Group
